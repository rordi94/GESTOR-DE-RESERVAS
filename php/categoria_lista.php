...
';
 //substr es una funcion que limita la cantidad de caracteres que tiene un campo    
if($total>=1 && $pagina<=$Npaginas){
    ...
    foreach($datos as $rows){
        ...
        <tr class="has-text-centered" >
                    ...
                    <td>
                        <a href="index.php?vista=category_update&category_id_up='.$rows['categoria_id'].'" class="button is-success is-rounded 
...
if($total>=1 && $pagina<=$Npaginas){
    ...
    $tabla.='    <p class="has-text-right">Mostrando Categorias <strong>'.$pag_inicio.'</strong> al
