...
<div class="container pb-6 pt-6">
        ...
        <?php 
            ...
            $id=(isset($_GET['product_id_up'])) ? $_GET['product_id_up'] : 0 ;  // operador ternario que indica que si la variable user_id_up viene definida se el asigna el mismo valor o se le asigna 0
...
//cuando la imagen no  existe
		...
		<div class="column">
			<form class="mb-6 has-text-centered FormularioAjax" action="./php/producto_img_actualizar.php" method="POST" 
            enctype="multipart/form-data" autocomplete="off" >

				<h4 class="title is-4 mb-6"><?php $datos['producto_nombre']; ?></h4>
				...
				<div class="file has-name is-horizontal is-justify-content-center mb-6">
				  	<label class="file-label">
				    	<input class="file-input" type="file" name="producto_foto"
                         accept=".jpg, .png, .jpeg" >
				    	<span class="file-cta">
