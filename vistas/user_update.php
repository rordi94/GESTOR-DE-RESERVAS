<?php
    ...
    $id=(isset($_GET['user_id_up'])) ? $_GET['user_id_up'] : 0 ;  // operador ternario que indica que si la variable user_id_up viene definida se el asigna el mismo valor o se le asigna 0
